...
export default function ResultCard({ result }: ResultCardProps) {
  return (
    <motion.section
      ...
      className="relative rounded-2xl border border-primary/30 bg-card shadow-card overflow-hidden"
    ...
    >
      ...
      {/* Header */}
      <div className="px-6 sm:px-8 pt-6 pb-4 flex items-center gap-3">
        ...
        <div className="ml-auto">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/15 border border-primary/30 text-xs text-primary font-medium">
